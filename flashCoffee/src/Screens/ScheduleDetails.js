                ...
                <View style={styles.card}>
                    <View style={styles.row}>
                        <View>
                            ...
                            source={{uri: 'https://ik.imagekit.io/tvlk/blog/2020/05/Ascott-Sudirman-Jakarta.jpeg'}}
                            />
                        </View>
                        <View style={{marginHorizontal:15}}>
                            <Text style={{fontWeight:'bold', fontSize:17, marginBottom:5,}}>Mediterania Garden Residence</Text>
                            <Text style={{color:'#a0a0a0'}}>Main Lobby Lt 5 Apartemen Boulevard</Text>
